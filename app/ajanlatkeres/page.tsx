...
const TRUST = [
  ...
  'Nem értékesítő hív — hanem aki a munkát csinálja',
];

const TOPICS = [
  'Új weboldal',
  'Webshop indítás',
  'Régi oldal felújítása',
  'Arculat & webdesign',
  'SEO & Google Ads',
  'Karbantartás',
  'Egyéb / nem tudom még',
...
const BUDGETS = ['300–500 ezer', '500e – 1 millió', '1–1,5 millió', '1,5M felett / nem tudom'];
    ...
    <>
      ...
      <header className="page-head">
        <div className="container">
          ...
          <p className="page-lead">Mondd el pár mondatban, mire van szükséged — két munkanapon belül küldünk egy konkrét, tételes árajánlatot, és időpontot egyeztetünk egy díjmentes konzultációra. Nincs kötelezettség, nincs marketing duma.</p>

          <ul className="head-checks">
            {TRUST.map((t) => (
              <li key={t}>
                <span className="hc-ico"><Check size={13} strokeWidth={3} /></span>
                {t}
              </li>
            ))}
          </ul>
            ...
            <div className="why-grid">
              ...
              <div className="why-feat">
                ...
                <div className="feat">
                  ...
                  <p>30 perc telefon vagy Meet — átbeszéljük, mit szeretnél, milyen tartalmaid vannak. Nem adunk el semmit.</p>
                ...
                <div className="feat">
                  ...
                  <p>Aláírjuk, jön a 30%-os előleg, és pár napon belül elküldjük az első wireframe-eket.</p>
